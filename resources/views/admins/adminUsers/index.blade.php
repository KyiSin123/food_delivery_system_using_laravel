                        ...
                        <tbody>
                            @forelse ($admins as $admin)
                                <tr>
                                    ...
                                    <td>
                                        <button onclick="edit({{ $admin }})" type="button" class="btn btn-success" id="editAdmin">
                                            <i class="fas fa-edit"></i> Edit
                                        </button>
                                        <x-admin.button.delete :name="'admin-delete-' . $admin->id" :url="route('admins.adminUsers.destroy', $admin->id)" />
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td class="text-center" colspan="12">No admin user to show.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
