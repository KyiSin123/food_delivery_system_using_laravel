...
@section('content')
    <div class="post-form p-5">
        <div class="col-lg-6 col-md-9 col-12 post-create">
            <div class="card p-lg-5 p-md-3 p-3 shadow">
                <h2 class="create-post">Update your shop's info:</h2>
                <form method="POST" action="{{ route('shops.edit', $shop->id) }}" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="my-3">
